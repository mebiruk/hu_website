...
AdminUser.create!(first_name: "keber",last_name: "eniyew", email: "kiber@gmail", password: "password", password_confirmation: "password", role: "admin") if Rails.env.development?
